 ...
 */
@Deprecated(
    "Renamed to com.eaglesakura.armyknife.widgets.view.SupportArrayAdapter",
    ReplaceWith("Renamed to com.eaglesakura.armyknife.widgets.view.SupportArrayAdapter")
)
