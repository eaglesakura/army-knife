...
package com.eaglesakura.ktx.android.gms
...
import com.eaglesakura.ktx.android.gms.error.PlayServiceNotAvailableException
import com.eaglesakura.ktx.android.extensions.awaitWithSuspend
import com.eaglesakura.ktx.android.extensions.connect
import com.eaglesakura.ktx.android.extensions.use
...
object GooglePlayService {
    ...
    suspend fun newSignInIntent(builder: GoogleApiClient.Builder, withSignOut: Boolean = true): Intent {
        return builder.connect(GoogleApiClient.SIGN_IN_MODE_OPTIONAL).use { client ->
            if (withSignOut) {
                Auth.GoogleSignInApi.signOut(client).awaitWithSuspend()
            }
