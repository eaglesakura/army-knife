...
/**
 * Copy from androidx.test.ext.junit.runners.AndroidJUnit4 by @eaglesakura.
 * <p>
 * This class supports ShadowLog.stream link to println.
 * <p>
 ...
 *
 * <p>Usage {@code @RunWith(CompatibleAndroidJUnit4.class)}
 */
public final class CompatibleAndroidJUnit4 extends Runner implements Filterable, Sortable {

    private static final String TAG = "CompatibleAndroidJUnit4";
    ...
    public CompatibleAndroidJUnit4(Class<?> klass) throws InitializationError {
    ...
    private static void throwInitializationError(String delegateRunner, Throwable cause)
        ...
        throw new InitializationError(
                new RuntimeException(
                        String.format(
                                "Delegate runner '%s' for CompatibleAndroidJUnit4 could not be loaded.", delegateRunner),
                        cause));
    }
